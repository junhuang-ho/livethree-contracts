...
contract DiamondInit {
    function init(
        ...
        address _feeAddress,
        uint256 _minContractGelatoBalance,
        ISuperfluid _sfHost,
        ...
        s.supportedInterfaces[type(IStreamSetup).interfaceId] = true;
        ...
        LibAutomate._setMinContractGelatoBalance(_minContractGelatoBalance);
